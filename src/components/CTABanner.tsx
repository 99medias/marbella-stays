...
export default function CTABanner() {
  ...
  return (
    <section className="relative overflow-hidden bg-navy py-24 px-5 md:px-8" ref={scrollRef}>
      {/* Animated decorative gradient blobs */}
      <div className="absolute right-0 top-0 h-96 w-96 rounded-full bg-golden opacity-10 blur-3xl blob-animate" />
      <div className="absolute bottom-0 left-0 h-64 w-64 rounded-full bg-terracotta opacity-10 blur-3xl blob-animate-delayed" />
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="animate-on-scroll delay-2 flex flex-col items-center justify-center gap-4 sm:flex-row">
        ...
        {/* Trust badges */}
        <div className="animate-on-scroll delay-3 mt-14 flex flex-wrap justify-center gap-8 sm:gap-12">
          {[
